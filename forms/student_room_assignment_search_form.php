...
<head>
    ...
    <title>Search Student Room Assignment</title>
...
<body>
    ...
    <div class="min-h-screen bg-neutral-950 text-white pt-5">
        <div class="bg-zinc-800 mx-auto p-4 rounded-lg container">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold">Search Student's Room Details</h2>
            ...
            <form action="#" id="searchForm" method="POST" class="flex flex-col max-w rounded px-8 pt-6 pb-2">
                ...
                <div>
                    <button type="submit" onclick="submitSearchForm()" class="bg-cyan-800 hover:bg-cyan-900 text-white w-full font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline">Search Assigned Room</button>
                </div>
            </form>
            <div class="m-4">
            <?php
    ...
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "SELECT * FROM student_room_assignment WHERE student_id='$student_id';";
