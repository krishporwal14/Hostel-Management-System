...
<body>
    ...
    try {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "DELETE FROM fees WHERE student_id='$student_id';";
            ...
            header("Location: fees_delete_form.php?success=true");
            exit();
        }
    } catch (Exception $e) {
    ...
    <div class="min-h-screen bg-neutral-950 text-white pt-5">
        <div class="bg-zinc-800 mx-auto p-4 rounded-lg container mb-28">
            <div class="flex justify-between items-center">
                <h2 class="text-2xl font-bold">Delete Fee Details</h2>
            ...
            <form action="#" id="deleteForm" method="POST" class="flex flex-col max-w rounded px-8 pt-6 pb-2">
                ...
                <div>
                    <button type="submit" onclick="submitDeleteForm()" class="bg-red-800 hover:bg-red-900 text-white w-full font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline">Delete Fee Entry</button>
                </div>
            </form>
